...
<%
	...
	try {
		...
		while (rs.next()) {
			...
			vocabularyDTO.setWord_2(rs.getString("word_2"));
			vocabularyDTO.setDescription_2(rs.getString("description_2"));
...
<div id="menu1">
	...
	<H2>고교 영어2</H2>
		<HR>
			<table border=1>
				<tr>
					<td colspan=7 align=center>고교 영어2</td>
				</tr>
				<tr>
					<th>단어</th>
					<th>단어설명</th>
				...
				%>
				<tr>
					<td><%=vocabularyDTO.getWord_2()%></td>
					<td><%=vocabularyDTO.getDescription_2()%></td>
					</tr>
				<%
					}
					}
